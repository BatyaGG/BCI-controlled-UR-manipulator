...
where _y<sub>t</sub>_ is acquired data point, _f(t)_ is a linear trend component and _s<sub>t</sub>_ is useful signal. To determine _f(t)_ slope <p>&Hat</p> and shift $\hat{b}$ should be determined by least-squares fit.
